...
import wget
# import numpy as np
# dtype = np.sctypes['int']  # Deprecated


print("Creating manifest file")
audio_folder_path = "/media/nayan/g/kumar/speaker_diarisation/primock57/output/mixed_audio"
...
clustering_output_dir = "nemo_neural_preds"
